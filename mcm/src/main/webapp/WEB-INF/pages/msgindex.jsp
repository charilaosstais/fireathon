...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="resources/index.html" class="logo">
      ...
      <span class="logo-lg"><b>MCM</b> Κέντρο Ελέγχου</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Εχετε 4 Νεα μηνύματα</li>
              <li>
              ...
              <li class="footer"><a href="resources/#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">10 Νεες ειδοποιήσεις</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li>
                    <a href="resources/#">
                      <i class="fa fa-users text-aqua"></i> Προστέθηκαν 123 νέοι εθελοντές
                    </a>
                  </li>
                  <li>
                    <a href="resources/#">
              ...
              <li class="footer"><a href="resources/#">View all</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Εχετε 9 Εργασίες σε εξέλιξη</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li><!-- Task item -->
              ...
              <li class="footer">
                <a href="resources/#">View all tasks</a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            <a href="resources/#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Δήμος Σικυωνίων</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Κέντρο Ελέγχου Δήμου Σικυωνίων
                  <small>Υπευθυνος Διαχειριστής : Μυττάς Ιωάννης</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="resources/#">Followers</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="resources/#">Sales</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="resources/#">Friends</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="resources/#" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="resources/#" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="resources/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Μυττάς Ιωάννης</p>
          <a href="resources/#"><i class="fa fa-circle text-success"></i> Σε σύνδεση</a>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">ΠΙΝΑΚΑΣ ΕΠΙΛΟΓΩΝ</li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="resources/#"><i class="fa fa-circle-o"></i> Level One</a></li>
            <li class="treeview">
              <a href="resources/#"><i class="fa fa-circle-o"></i> Level One
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="resources/#"><i class="fa fa-circle-o"></i> Level Two</a></li>
                <li class="treeview">
                  <a href="resources/#"><i class="fa fa-circle-o"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="resources/#"><i class="fa fa-circle-o"></i> Level Three</a></li>
                    <li><a href="resources/#"><i class="fa fa-circle-o"></i> Level Three</a></li>
                  </ul>
                </li>
              </ul>
        ...
        <li><a href="resources/https://adminlte.io/docs"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
        <li class="header">LABELS</li>
        <li><a href="resources/#"><i class="fa fa-circle-o text-red"></i> <span>Important</span></a></li>
        <li><a href="resources/#"><i class="fa fa-circle-o text-yellow"></i> <span>Warning</span></a></li>
        <li><a href="resources/#"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Δημοτική Διαχειριση Κρίσεων
        <small>Κέντρο Επικοινωνίας</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="resources/#"><i class="fa fa-dashboard"></i> ΑΡΧΙΚΗ</a></li>
        <li class="active">ΣΥΣΤΗΜΑ ΔΙΑΧΕΙΡΙΣΗΣ</li>
      </ol>
    </section>
    ...
    <section class="content">
	  ...
	  <div class="callout callout-danger">
                <h4>Συμβάν Σε εξέλιξη</h4>

                <p>Πυρακαγια στην Περιοχή Κάτω Διμηνιου.</p>
              </div>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Υπηρεσίες Αστυνομίας</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="resources/#" class="small-box-footer">Περισσότερα <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <p>Ομάδες Πολιτικής Προστασίας</p>
            </div>
            <div class="icon">
      ...
      <div class="row">
		...
		<div class="box box-success">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="resources/#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="resources/#sales-chart" data-toggle="tab">Donut</a></li>
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="box box-solid bg-light-blue-gradient">
            ...
            <div class="box-body">
              <div id="mapdiv" style="height: 250px; width: 100%;">
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="resources/#">Add new event</a></li>
                    <li><a href="resources/#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="resources/#">View calendar</a></li>
                  </ul>
                </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="resources/https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li><a href="resources/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="resources/#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="resources/javascript:void(0)">
    ...
    $.getJSON('locations.json', function(data) {
      ...
      $.each(data.locationList, function() {
       ...
       // var pointFeatures = [];
        ...
        var markerInfo = "<p><div style='color:black'>Name: " + this.device.actor.name + 
        				 "<br/>Team: " + this.device.actor.teamActors[0].team.name + "</div></p>" +
        				 "<button id='sms' onclick='myFunction()' style='color:black'>Send message</button>"; 
     	...
     	$( function() {
    		...
    		function sendMessage() {
    			var url = 'https://www.smsn.gr/api/http/send.php?username=superis&password=testfireathon&from=MCM&message=' +
    				message +
    				'&to=00306978827006'
    			$.ajax({
    				type: "GET",
